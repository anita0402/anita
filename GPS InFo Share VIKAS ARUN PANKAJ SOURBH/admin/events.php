...
<link rel="stylesheet" href="css1/events.css">
</head>
<body>   
<header>
   <h1> GPS InFo Share </h1>
	...
	<main>
	<div class ="events">
	  <form action ="../ACTION/eventsaction.php" method="post">
	   <p> Events-box</p>
		<input type="text"name="Title" id="Title" placeholder="Enter Title"><br><br>
       <textarea name="message" id="message"placeholder="Enter Message here...."></textarea><br><br>
	...
	<ul class="footer-links-main">
	    ...
	    <ul class="footer-links-Admin">
	      <li><a href ="#">Gallery</a></li>
	      <li><a href="#">Notification</a></li>
	      <li><a href ="#">Events</a></li>
	      <li><a href="#">Feedback</a></li>
	      <li><a href="#">Login Checker</a></li>
	     </ul>
		 <div class="footer-sm">
		  <a href="#">
